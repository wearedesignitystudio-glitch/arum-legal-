...
export function PurposeBanner() {
  return (
    <section className="shop-purpose">
      <div className="container-narrow">
        <p className="kicker">Why it matters</p>
        <h2>
          Your purchase is not just helping — it is helping those who don’t have anyone.
        </h2>
        <p>
  ...
  return (
    <section className="bundle-section">
      <div className="container">
        <div className="section-head-shop">
            ...
            <article key={bundle.id} className="bundle-card">
              ...
              <div className="bundle-card-body">
                ...
                <div className="bundle-actions">
                  <Button type="button" variant="primary" onClick={() => addBundle(bundle.id, bundle.name)}>
                    Add bundle
                  </Button>
